                ...
                <div className='px-14'> 
                    ...
                    <div>
                        ...
                        <div className='w-full pb-8 border-b-2 border-slate-300'>
                            <span>
                                <h1 className='text-3xl font-medium font-serif text-[#2E4049]'>Donate For Our Cause</h1>
                            </span>
                        </div>
                        ...
                        <section className='py-8 border-b border-slate-200'>
                            ...
                            <div>
                                <span>
                                    <h2 className='pb-4 text-2xl font-medium text-[#2E4049]'>Our Goal</h2>
                                </span>
                            </div>
                            {/* description content */}
                                <div>
                            ...
                            <div>
                                <span>
                                    <h2 className='pb-4 text-2xl font-medium text-[#2E4049]'>Details about the Cause</h2>
                                </span>
                            </div>
                            {/* description content */}
                                <div>
